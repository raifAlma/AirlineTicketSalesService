...
status: Mapped[StatusType] = mapped_column(Enum(StatusType), nullable=False, default=StatusType.SCHEDULED)

aircraft: Mapped['Aircraft'] = relationship(back_populates="flight")
departure_airport: Mapped['Airport'] = relationship('Airport',
                                                    foreign_keys='departure_airport_id',
                                                    back_populates='departures')
arrival_airport: Mapped['Airport'] = relationship('Airport',
